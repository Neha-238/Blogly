    ...
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        ...
        <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs">
          ...
          write without filters. Whether its one word or a thousand, your story
          starts right here
        </p>
        ...
        >
          <input
            ref={inputRef}
            type="text"
            placeholder="serach for blogs"
            required
            className="w-full pl-4 outline-none"
          />
          <button
            type="submit"
            className="bg-[#5044e5] text-white px-8 py-2 m-1.5 rounded hover:scale-105 transition-all cursor-pointer"
          >
            Search
          </button>
        </form>
